            ...
            getData: function (elem, data) {
                $.each(data, function (index, value) {
                    var item = '<div class="item">'
                        ...
                        + ' </a>'
                        + ' <span class="price">210.000đ <span class="pull-right"><i class="fa fa-comment" aria-hidden="true">12</i></span></span>'
                        + '</div>'
    ...
    $("#section").append('<div class="section-body" id="listactivity">'
                         ...
                         + '</div>'
                             ...
                             if (data.length > 0) {
                                 ...
                                 $('#listactivity').empty();
                                 $("#listactivity").loadJson({
                                     url: '/api/activityinfomation/getallbymultilactivityid?id=' + mData + '',
                                     loadBtn: '#btn',
                                     limit: 12,
                                     loadItem: 12,
                                     beforeSend: function () {
